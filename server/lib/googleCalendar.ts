...
export const callGoogleCalendarApi = async (token: string, endpoint: string, method: string, payload: object|null = null, calendarId = globalThis.__env__.CALENDAR_ID): Promise<any> => {
